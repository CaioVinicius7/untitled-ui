...
const button = tv({
  base: [
    ...
    "focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-violet-500 dark:focus-visible:ring-offset-zinc-900",
    "active:opacity-80"
  ],
  ...
  variants: {
    variant: {
      ...
      ghost:
        "rounded-md px-2 hover:bg-zinc-50 shadow-none text-zinc-500 dark:hover:bg-white/5",
      outline:
